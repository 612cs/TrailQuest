  ...
  <Teleport to="body">
    <Transition name="fade">
      <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center px-4 pointer-events-none">
        ...
        <!-- Modal Content -->
        <div class="relative w-full max-w-md rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.15)] overflow-hidden flex flex-col max-h-[90vh] pointer-events-auto" style="background-color: var(--bg-card);">
          <!-- Header -->
