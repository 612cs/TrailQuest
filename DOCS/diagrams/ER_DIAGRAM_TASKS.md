...
├── users_table.drawio                          ✅
├── trails_table.drawio                         ✅
├── reviews_table.drawio                        ✅
├── media_files_table.drawio                    ✅
├── database_relations.drawio                   ✅
├── tags_table.drawio                           ✅
├── trail_tags_table.drawio                     ✅
├── trail_images_table.drawio                   ✅
├── trail_favorites_table.drawio                ✅
├── trail_likes_table.drawio                    ✅
├── trail_tracks_table.drawio                   ✅
├── review_images_table.drawio                  ✅
├── ai_messages_table.drawio                    ✅
├── user_hiking_profiles_table.drawio           ✅
├── admin_operation_logs_table.drawio           ✅
├── app_settings_table.drawio                   ✅
├── upload_checkpoints_table.drawio             ✅
├── landscape_feature_snapshots_table.drawio    ✅
├── landscape_observation_labels_table.drawio   ✅
├── system_option_groups_table.drawio           ✅
└── system_option_items_table.drawio            ✅
```
