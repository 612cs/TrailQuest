...
-- 路线收藏
INSERT INTO `trail_favorites` (`trail_id`,`user_id`) VALUES
(1,101),
(1,102),
(2,104);
...
-- AI 会话
INSERT INTO `ai_conversations` (`id`,`user_id`,`title`,`model`,`status`) VALUES
(1,101,'杭州周边徒步推荐','gpt-4.1','active'),
(2,102,'一日轻装线路规划','gpt-4.1','active');

-- AI 消息
INSERT INTO `ai_messages` (`conversation_id`,`role`,`content`,`tokens`) VALUES
(1,'user','帮我推荐杭州周边适合周末的一日徒步路线',56),
(1,'assistant','推荐你去临安附近的老鹰峰顶，路线适中，风景好，周末人也不会太多。',84),
(2,'user','大理附近轻装一日线路有哪些？',42),
(2,'assistant','镜湖环线比较适合轻装一日行程，路况平缓，适合拍照与休闲。',76);
```
