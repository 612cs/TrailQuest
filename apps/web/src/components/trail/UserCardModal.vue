  ...
  <Teleport to="body">
    <Transition name="user-card-fade">
      <div v-if="show" class="fixed inset-0 z-[80] flex items-center justify-center px-4">
        ...
        <div
          class="relative w-full max-w-sm overflow-hidden rounded-3xl border shadow-[0_24px_60px_rgba(0,0,0,0.16)]"
          style="background-color: var(--bg-card); border-color: var(--border-default)"
        >
          <button
            type="button"
            class="hover:bg-primary-500/8 absolute top-4 right-4 z-10 flex h-9 w-9 items-center justify-center rounded-full border transition-colors"
          ...
          >
            ...
            <div v-else-if="errorMessage" class="py-8 text-center">
              <div
                ...
                style="
                  background-color: color-mix(in srgb, var(--color-hard) 10%, transparent);
            ...
            <div v-else-if="userCard" class="space-y-5">
                ...
                <div class="min-w-0 flex-1">
                  <div class="flex flex-wrap items-center gap-2">
                    ...
                    <span
                      ...
                      style="background-color: var(--bg-tag); color: var(--primary-500)"
                    >
              ...
              <div class="grid grid-cols-2 gap-3">
                ...
                >
                  <p
                    class="text-[11px] tracking-[0.12em] uppercase"
              ...
              <div class="grid grid-cols-2 gap-3">
                <div class="rounded-2xl px-4 py-3" style="background-color: var(--bg-tag)">
                  ...
                  <p class="text-primary-500 mt-1 text-xl font-semibold">
                    {{ userCard.postCount }}
                  </p>
                </div>
                <div class="rounded-2xl px-4 py-3" style="background-color: var(--bg-tag)">
