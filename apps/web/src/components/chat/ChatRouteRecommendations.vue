    ...
    >
      <div class="flex gap-3">
        <img
          :src="item.image"
          :alt="item.name"
          class="h-24 w-28 rounded-2xl object-cover sm:h-28 sm:w-36"
        />
        <div class="min-w-0 flex-1 space-y-2">
          ...
          >
            <span class="flex items-center gap-1"
              ><BaseIcon name="TrendingUp" :size="14" />{{ item.distance }}</span
            >
            <span class="flex items-center gap-1"
              ><BaseIcon name="Mountain" :size="14" />{{ item.elevation }}</span
            >
            <span class="flex items-center gap-1"
              ><BaseIcon name="Clock" :size="14" />{{ item.duration }}</span
            >
          </div>
        </div>
      </div>
