...
<template>
  ...
  >
    <div
      ...
      style="background-color: var(--bg-secondary); padding: 12px; border-radius: 8px"
    >
      <div
    ...
    <template #footer>
      <div class="flex justify-end gap-3">
        <button
          type="button"
          class="hover:bg-primary-500/10 rounded-xl px-4 py-2 text-sm font-medium transition-colors disabled:cursor-not-allowed disabled:opacity-60"
